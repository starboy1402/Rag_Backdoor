        ...
        "cells": [
            ...
            },
            {
                ...
                "source": [
                    ...
                    "3. Add your Hugging Face token under **Add-ons -> Secrets** as `HF_TOKEN` (needed for `google/gemma-2b-it`)."
                ]
            },
            {
                "cell_type": "code",
                ...
                "outputs": [],
                "source": [
                    "# If running from a freshly uploaded notebook on Kaggle, clone the project files:\n",
                    "import os\n",
                    "\n",
                    "# Check if project files are already in current directory\n",
                    "if not os.path.exists('scripts/validate_env.py'):\n",
                    "    print('Cloning repository into Kaggle working directory...')\n",
                    "    # Replace with your GitHub repo URL, or upload the repository directory\n",
                    "    !git clone https://github.com/starboy1402/Rag_Backdoor.git /kaggle/working/Rag_Backdoor\n",
                    "    %cd /kaggle/working/Rag_Backdoor\n",
                    "else:\n",
                    "    print('Project files already present in working directory.')\n",
                    "\n",
                    ...
                    "    print(f'Hugging Face secret not found ({e}). If accessing gated models, provide your token.')\n"
                ]
            },
            {
                "cell_type": "markdown",
